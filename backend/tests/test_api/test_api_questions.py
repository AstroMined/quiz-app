...
def test_create_question(logged_in_client, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    question_data = {
...
def test_create_question_with_answers(logged_in_client, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    question_data = {
    ...
    assert any(choice["text"] == "Jupiter" and choice["is_correct"] for choice in created_question["answer_choices"])
...
def test_update_question(logged_in_client, test_model_questions, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    update_data = {
    ...
    response = logged_in_client.put(f"/questions/{test_model_questions[0].id}", json=update_data)
    assert response.status_code == 200
...
def test_create_question_unauthorized(client, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    question_data = {
...
def test_update_nonexistent_question(logged_in_client, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    update_data = {
...
def test_create_question_invalid_data(logged_in_client, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
...
def test_create_question_with_invalid_answers(logged_in_client, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    invalid_question_data = {
    ...
    response = logged_in_client.post("/questions/with-answers/", json=invalid_question_data)
    assert response.status_code == 422
...
def test_update_question_invalid_data(logged_in_client, test_model_questions):
    ...
    response = logged_in_client.put(f"/questions/{test_model_questions[0].id}", json=invalid_update_data)
    assert response.status_code == 422

def test_get_questions_pagination(logged_in_client, db_session, test_model_subject, test_model_topic, test_model_subtopic, test_model_concept):
    # Create 15 questions
    for i in range(15):
...
def test_update_question_no_changes(logged_in_client, test_model_questions):
    ...
    response = logged_in_client.put(f"/questions/{current_question.id}", json=update_data)
    assert response.status_code == 200
    updated_question = response.json()
