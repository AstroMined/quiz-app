...
logging.basicConfig(
    filename=processed_dir / "process_log.log",
    level=logging.ERROR,
...
def find_json_files(directory, filenames):
    ...
    for filename in filenames:
        ...
        if (
            filepath.is_file() and os.path.getsize(filepath) > 0
...
if __name__ == "__main__":
    filenames = [
        "create_epics_features.json",
        "create_user_stories.json",
        "create_tasks.json",
        "create_bugs_issues.json",
    ]
    try:
