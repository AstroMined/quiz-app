...
def log_pool_info():
    if hasattr(engine.pool, "size"):
        ...
        logger.info("  Pool size: %s", engine.pool.size())
        logger.info("  Connections in use: %s", engine.pool.checkedin())
        logger.info("  Connections available: %s", engine.pool.checkedout())
    else:
