...
def convert_csv_to_markdown(csv_file_path, template_file_path, output_file_path):
    ...
    final_markdown = template_content.replace('<details from /code/quiz-app/backend/new-work-items/new-work-items.csv>', markdown_content)
...
if __name__ == "__main__":
    csv_file_path = '/code/quiz-app/backend/new-work-items/new-work-items.csv'
    template_file_path = '/code/quiz-app/backend/new-work-items/new-work-items-prompt-template.md'
    output_file_path = '/code/quiz-app/backend/new-work-items/new-work-items-prompt.md'
